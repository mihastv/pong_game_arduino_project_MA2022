...
#define DiagonalballUpdateTime 30
#define HorizontalballUpdateTime 20
...
void Ball :: AwardAPoint()
{
  ...
  // When one of the player reaches the winning score of 3
  
  if(p1.Score == 3)            // If Player 1 reaches 3 first
  {
    g.Print_Winner(Player_1);   // Printing Player 1 as Winner
  }

  else if(p2.Score == 3)       // If Player 2 reaches 3 first
  {
